...
private:
    ...
    struct ConstantText
    {
        ...
        void init(wxFont init_font)
        {
            ...
            // credits infornation
            credits = _L("SuperSlicerMx is a modified version of SuperSlicer, which is a skinned version of Slic3r, based on PrusaSlicer by Prusa and the original Slic3r by Alessandro Ranellucci & the RepRap community.") + "\n\n" +
